...
const codeLines = [
  ...
  { tokens: [{ t: 'plain', v: '});' }] },
  { tokens: [] },
  { tokens: [{ t: 'comment', v: '// React component' }] },
  { tokens: [{ t: 'keyword', v: 'export default function' }, { t: 'fn', v: ' BirthdayCard' }, { t: 'plain', v: '() {' }] },
  { tokens: [{ t: 'keyword', v: '  return' }, { t: 'plain', v: ' (' }] },
  { tokens: [{ t: 'plain', v: '    <' }, { t: 'tag', v: 'div' }, { t: 'attr', v: ' className' }, { t: 'plain', v: '=' }, { t: 'string', v: '"card"' }, { t: 'plain', v: '>' }] },
  { tokens: [{ t: 'plain', v: '      <' }, { t: 'tag', v: 'h1' }, { t: 'plain', v: '>' }, { t: 'string', v: 'Happy Birthday, Lama!' }, { t: 'plain', v: '</' }, { t: 'tag', v: 'h1' }, { t: 'plain', v: '>' }] },
  { tokens: [{ t: 'plain', v: '    </' }, { t: 'tag', v: 'div' }, { t: 'plain', v: '>' }] },
  { tokens: [{ t: 'plain', v: '  );' }] },
  { tokens: [{ t: 'plain', v: '}' }] },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <Reveal className="space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="heading-xl text-white">
                  Happy Birthday,{' '}
                  <span className="text-brand">Lama</span>
                  <br />
                  Seleman
                </h1>
            ...
            <Reveal delay={150} className="relative group">
              ...
              <div className="absolute -bottom-6 -right-6 px-6 py-4 bg-brand rounded-xl shadow-2xl border-4 border-[#18181B]">
                <div className="heading-sm text-white">Happy Birthday</div>
              </div>
            </Reveal>
