...
const movies = [
  {
    name: "The Wild Robot",
    year: 2024, genre: 'Animation · Sci-Fi',
    thumb: 'https://upload.wikimedia.org/wikipedia/en/b/ba/The_Wild_Robot_poster.jpg',
    netflix: 'the+wild+robot+2024', prime: 'The+Wild+Robot', youtube: 'The+Wild+Robot+full+movie'
  },
  {
    name: "Inside Out 2",
    year: 2024, genre: 'Animation · Adventure',
    thumb: 'https://upload.wikimedia.org/wikipedia/en/f/f7/Inside_Out_2_poster.jpg',
    netflix: 'inside+out+2', prime: 'Inside+Out+2', youtube: 'Inside+Out+2+full+movie'
  },
  {
    name: "Moana 2",
    year: 2024, genre: 'Animation · Musical',
    thumb: 'https://upload.wikimedia.org/wikipedia/en/7/73/Moana_2_poster.jpg',
    netflix: 'moana+2', prime: 'Moana+2', youtube: 'Moana+2+full+movie'
  },
  {
    name: "Wicked",
    year: 2024, genre: 'Fantasy · Musical',
    thumb: 'https://upload.wikimedia.org/wikipedia/en/b/b1/Wicked_-_Part_1_poster.jpg',
    netflix: 'wicked+2024', prime: 'Wicked+2024', youtube: 'Wicked+2024+full+movie'
  },
  {
    name: "Spirited Away",
    year: 2001, genre: 'Animation · Fantasy',
    thumb: 'https://upload.wikimedia.org/wikipedia/en/d/db/Spirited_Away_poster.png',
    netflix: 'spirited+away', prime: 'Spirited+Away', youtube: 'Spirited+Away+full+movie'
  },
  {
    name: "The Boy and the Heron",
    year: 2023, genre: 'Animation · Fantasy',
    thumb: 'https://upload.wikimedia.org/wikipedia/en/3/3e/The_Boy_and_the_Heron_poster.jpg',
    netflix: 'the+boy+and+the+heron', prime: 'The+Boy+and+the+Heron', youtube: 'The+Boy+and+the+Heron+full+movie'
  },
  {
    name: "Mufasa: The Lion King",
    year: 2024, genre: 'Adventure · Drama',
    thumb: 'https://upload.wikimedia.org/wikipedia/en/6/69/Mufasa_The_Lion_King_poster.jpg',
    netflix: 'mufasa+the+lion+king', prime: 'Mufasa+The+Lion+King', youtube: 'Mufasa+The+Lion+King+full+movie'
  },
  {
    name: "Fantastic Beasts",
    year: 2016, genre: 'Fantasy · Adventure',
    thumb: 'https://upload.wikimedia.org/wikipedia/en/3/3e/Fantastic_Beasts_and_Where_to_Find_Them_poster.png',
    netflix: 'fantastic+beasts+and+where+to+find+them', prime: 'Fantastic+Beasts', youtube: 'Fantastic+Beasts+full+movie'
  },
  {
    name: "The Woman King",
    year: 2022, genre: 'Action · History',
    thumb: 'https://upload.wikimedia.org/wikipedia/en/4/43/The_Woman_King_poster.jpg',
    netflix: 'the+woman+king', prime: 'The+Woman+King', youtube: 'The+Woman+King+full+movie'
  },
  {
    name: "Mulan",
    year: 1998, genre: 'Animation · Action',
    thumb: 'https://upload.wikimedia.org/wikipedia/en/a/a3/Movie_poster_mulan.jpg',
    netflix: 'mulan+1998', prime: 'Mulan+1998', youtube: 'Mulan+1998+full+movie'
  },
  {
    name: "Dune: Part Two",
    year: 2024, genre: 'Sci-Fi · Adventure',
    thumb: 'https://upload.wikimedia.org/wikipedia/en/5/52/Dune_Part_Two_poster.jpg',
    netflix: 'dune+part+two', prime: 'Dune+Part+Two', youtube: 'Dune+Part+Two+full+movie'
  },
  {
    name: "Orion and the Dark",
    year: 2024, genre: 'Animation · Comedy',
    thumb: 'https://upload.wikimedia.org/wikipedia/en/d/d4/Orion_and_the_Dark_poster.jpg',
    netflix: 'orion+and+the+dark', prime: 'Orion+and+the+Dark', youtube: 'Orion+and+the+Dark+full+movie'
  }
];
