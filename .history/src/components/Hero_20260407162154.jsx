  ...
  return (
    <>
      <section className="bg-[#18181B] text-white relative overflow-hidden">
        <div className="max-container padding-container py-16 sm:py-20 lg:py-18 xl:py-18">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <Reveal className="space-y-6 lg:space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="text-3xl xs:text-4xl sm:text-5xl lg:text-6xl font-black text-white leading-[1.1] tracking-tight">
                  Happy Birthday,{' '}
                  <br className="hidden xs:block" />
                  Lama <span className="text-brand">Seleman</span>
                </h1>
                <p className="body-md lg:body-lg text-zinc-400 max-w-xl">
